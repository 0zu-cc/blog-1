...
CREATE TABLE `blog_article` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `blog_ARTICLE_URL` (`article_url`) USING BTREE,
  KEY `blog_ARTICLE_USERID` (`user_id`) USING BTREE
...
CREATE TABLE `blog_article_category` (
  ...
  KEY `blog_ARTILE_ID` (`article_id`) USING BTREE,
  KEY `blog_ARTILE_CATEGORY_ID` (`category_id`) USING BTREE
...
CREATE TABLE `blog_article_tag` (
  ...
  KEY `blog_ARTILE_ID` (`article_id`) USING BTREE,
  KEY `blog_ARTILE_TAG_ID` (`tag_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
