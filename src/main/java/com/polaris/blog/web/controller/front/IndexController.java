package com.polaris.blog.web.controller.front;

import java.util.List;

import javax.servlet.http.HttpServletRequest;

import com.polaris.blog.util.BlogUtil;
...
import com.polaris.blog.model.domain.Link;
...
import com.polaris.blog.model.enums.PageNumber;
import com.polaris.blog.model.enums.PostType;
import com.polaris.blog.service.ArticleService;
import com.polaris.blog.service.CategoryService;
import com.polaris.blog.service.LinksService;
import com.polaris.blog.service.TagService;
import com.polaris.blog.web.controller.admin.BaseController;
...
public class IndexController extends BaseController {
	...
	public boolean checkRepeatIp(HttpServletRequest request, int id) {
		...
		cache.hset("hits:frequency", value, 1, BlogConst.IP_REPEAT_TIME);
		return false;
	}
	...
	public void updateArticleViews(Integer id, Long views) {
		...
		if (cacheViews >= BlogConst.CLICK_EXCEED) {
	...
	public String rss() throws FeedException {
		...
		return BlogUtil.buildRss(articles);
	}
